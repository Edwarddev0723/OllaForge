...
def display_banner() -> None:
    ...
    Text(TAGLINE, style="italic bright_magenta")
...
def display_success(output_file: str, count: int, duration: float) -> None:
    ...
    content.append("📊 Entries: ", style="dim")
    content.append(f"{count}\n", style="bold yellow")
    content.append("⏱️  Duration: ", style="dim")
...
def augment_interactive() -> (
    ...
    from .file_manager import FileOperationError, read_jsonl_file
