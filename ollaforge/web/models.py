...
class GenerationRequest(BaseModel):
    ...
    count: int = Field(..., ge=1, le=10000, description="Number of data entries to generate")
                ...
                "previews": [
                    {
                        ...
                        "augmented": {"instruction": "Say hi", "output": "Good day, how may I assist you?"}
                    }
                ]
            }
        }
...
class ModelListResponse(BaseModel):
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "models": [
                    {"name": "llama3.2", "size": "3.2B", "modified_at": "2024-01-15T10:30:00Z"},
                    {"name": "mistral", "size": "7B", "modified_at": "2024-01-10T08:20:00Z"}
                ]
            }
        }
